...
<footer class="container-fluid">
	<div class="container">
		<div class="row">
			...
			<div id="footer1" class="footer col-md-4 col-sm-6 col-xs-12">
			...
			if ( is_active_sidebar( 'footer_3' ) ) { ?>
				<div id="footer2" class="footer col-md-4 col-sm-6 col-xs-12">
      ...
      <?php } ?>
			...
			<?php // Check whether Footer area #3 has any widgets
			if ( is_active_sidebar( 'footer_3' ) ) { ?>
				<div id="footer3" class="footer col-md-4 col-sm-12 col-xs-12">
